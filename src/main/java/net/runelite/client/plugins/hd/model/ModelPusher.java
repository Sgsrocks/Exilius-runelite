...
public class ModelPusher
{
    ...
    private int[] removeBakedGroundShading(int face, int triA, int triB, int triC, int[] faceTransparencies, short[] faceTextures, int[] yVertices) {
    ...
    private int[] getColorsForFace(Renderable renderable, Model model, ObjectProperties objectProperties, ObjectType objectType, int tileX, int tileY, int tileZ, int face) {
        ...
        final short[] faceTextures = model.getFaceTextures();
        final int[] faceTransparencies = model.getFaceTransparencies();
