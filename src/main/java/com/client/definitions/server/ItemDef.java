...
public class ItemDef {
    ...
    public static void load() throws Exception {
        ...
        List<ItemDef> list = JsonUtil.fromYaml(Signlink.findcachedir() + "etc/item_definitions.yaml", new TypeReference<List<ItemDef>>() {
        });
    ...
    public static class ItemDefBuilder {
        ...
        public ItemDef.ItemDefBuilder deletedOnDeath(final boolean deletedOnDeath) {
            this.deletedOnDeath = deletedOnDeath;
            return this;
        }
