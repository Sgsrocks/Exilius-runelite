	...
	public static void loadSprites() {
		try {
			Buffer index = new Buffer(
					FileOperations.readFile(Signlink.findcachedir() + "media_archives/media_archive3.idx"));
			Buffer data = new Buffer(
					FileOperations.readFile(Signlink.findcachedir() + "media_archives/media_archive3.dat"));
