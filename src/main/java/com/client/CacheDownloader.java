...
public class CacheDownloader {
	...
	public CacheDownloader(Client client) {
		Objects.requireNonNull(Signlink.findcachedir());
		this.client = client;
		fileLocation = Paths.get(Signlink.findcachedir(), getArchivedName());
	}

	private int getLocalVersion() {
		try(BufferedReader fr = new BufferedReader(new FileReader(Signlink.findcachedir() + File.separator + "version.dat"))){
...
//	}
	...
	public void writeVersion(int version) {
		File versionFile = new File(Signlink.findcachedir() + File.separator + "version.dat");
	...
	public CacheDownloader downloadCache() {
		...
		try {
			...
			File version = new File(Signlink.findcachedir() + "/version.dat");
	...
	private void unZip() throws IOException {
		...
		while ((e = zin.getNextEntry()) != null) {
			...
			File newFile = new File(Signlink.findcachedir() + File.separator + fileName);
			if (e.isDirectory()) {
